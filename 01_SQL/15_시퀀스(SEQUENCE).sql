/*
    ...
    시퀀스를 이용하면 중복 없는 숫자값을 편리하게 관리할 수 있음
*/
...
/*
    ...
    [START WITH 시작숫자] -> 처음 발생시킬 시작값을 지정(기본값 1)
    ...
    *캐시메모리 : 미리 일정량의 값들을 생성해서 메모리에 준비 -> 속도 향상
    ex) CACHE 20 -> 시퀀스를 미리 20개 만들어두고 필요할 때 꺼내 씀
*/
...
/*
    ...
    CURRVAL는 최초 사용시 오류 발생 -> NEXTVAL를 한 번이라도 호출해야 사용가능
*/
...
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE) VALUES(SEQ_EMPNO.NEXTVAL, '최지구','701001-1234567', 'J7');
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE) VALUES(SEQ_EMPNO.NEXTVAL, '최지','701001-1234567', 'J7');
