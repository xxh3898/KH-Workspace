...
public class Variable {
	...
	public static void main(String[] args) {
		...
		// 참과거짓을 표현하는 자료형으로 isTrue라는 이름의 변수 선언
		boolean isTrue=false; // 선언과 동시에 false라는 값을 대입
		isTrue=true;
		System.out.println(isTrue);
		
		// 실수형(소수점7자리까지 사용) 자료형으로 num2라는 이름의 변수를 선언
		float num2;
		num2=3.14354356456f;
		...
		String str1="안녕하세요 조치호입니다.";
		System.out.println(str1);    
		
		String str2;
		str2="누구?";
		str2="저는 누구가 아니라 조치호입니다.";
	// 	str2=null; // String의 변수는 참조변수이기 때문에 기본값이 null이고 빈값을 표현하기위해 null을 대입할 수 없다.
	...
	//	str3= null;
		...
		/*
		 * 이스케이프 시퀀스
		 * 문자열내에서 탭, 백슬래시, 작따옴표 등을 사용하기 위한 방식
		 * */
...
//		MY_AGE=111;	변경불가
		...
		/*
		 * 프로그래밍에서 이름 짓는 방식
		 * 카멜 케이스 : 단어를 나열하며 이름을 짓되, 두번째단어부터는 단어의 첫 글자를 대문자로 시작
		 * ex) userName, totalPrice
		 * 
		 * 파스칼케이스 : 카멜케이스에서 첫 글자도 대문자로 사용(자바에서는 클래스명에 사용)
		 * ex) UserName, TotalPrice
		 * 
