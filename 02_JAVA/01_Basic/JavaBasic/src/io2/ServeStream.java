...
public class ServeStream {
	 ...
	 * 		BurffedWriter : 편의성과 속도향상에 도움을 주는 보조스트림(기반스트림 없이 사용 불가)
	 */
...
//			System.out.println(br.readLine());
	...
	public void objectSave() {
		...
		Product p3=new Product("아이폰16se", 800000);
